					...
					<c:choose>
						<c:when test="${empty LoginOK}">
							<ul>					
								...
								<li><a href=<c:url value='/' /> style="margin: 10px"><span class="glyphicon glyphicon-user" aria-hidden="true" ></span>註冊</a></li>
							</ul>
						</c:when>
						<c:otherwise>
							<ul>
								...
								<li><a href=<c:url value='/'/> style="margin: 10px"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>修改基本資料</a></li>
							</ul>
						</c:otherwise>
					</c:choose>
				</div>
							...
							<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
								<nav class="link-effect-2 fixed-top" id="link-effect-2">
									<ul class="nav navbar-nav">
										...
										<li><a href=<c:url value='/productList' />><span data-hover="Market">市集</span></a></li>
										<li><a href=<c:url value='/MyOrders/Orders?page=1'/>><span data-hover="Order">訂單</span></a></li>
										<li><a href=<c:url value='/ShoppingCar/OrderCheck' />><span data-hover="Car">購物車</span></a></li>
										<li><a href=<c:url value='/shopCart' />><span data-hover="Car2">購物車2</span></a></li>
										<li><a href=<c:url value='/' />><span data-hover="course ">課程</span></a></li>
										<li><a href=<c:url value='#' />><span data-hover="backstage">員工後台</span></a></li>
									</ul>
								</nav>
							</div>
							<!-- /.navbar-collapse -->
